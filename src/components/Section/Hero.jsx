...
export default function Hero() {
  return (
    <div>
      <div className="h-screen bg-[#F5FCFF] flex">
        <div className="flex flex-wrap justify-center md:flex-nowrap md:items-center mx-6 md:mx-20">
          <div className="w-full md:w-1/2 flex items-center">
            <div className="flex-col">
              <p className="font-semibold text-xl">hi im Hijriyanto Wahyudi</p>
              <h1 className="font-bold text-3xl md:text-4xl capitalize">
                I am <span className="text-[#5E3BEE]">fullstack developer</span>{" "}
                and student
              </h1>
              <div className="mt-4">
                <button className="bg-[#5E3BEE] text-white px-4 py-2 rounded-e-full">
                  Contact Me Here !
                </button>
              </div>
              <div className="mt-4 ml-2 flex gap-3">
                <a href="https://api.whatsapp.com/send?phone=6283121065540" rel="noreferrer" target="_blank">
                  <svg
                ...
                <a href="https://www.facebook.com/profile.php?id=100073641038027&mibextid=ZbWKwL" rel="noreferrer" target="_blank">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="24"
                    height="24"
                ...
                <a href="https://www.instagram.com/yuu.jsx/" rel="noreferrer" target="_blank">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
